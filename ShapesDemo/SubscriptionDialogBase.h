...
class SubscriptionDialogBase : public wxDialog
{
public:
    SubscriptionDialogBase() {}
    SubscriptionDialogBase(wxWindow *parent, wxWindowID id = wxID_ANY, const wxString& title = "Subscription",
    ...
    bool Create(wxWindow *parent, wxWindowID id = wxID_ANY, const wxString& title = "Subscription",
        const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize,
        long style = wxDEFAULT_DIALOG_STYLE, const wxString &name = wxDialogNameStr);
